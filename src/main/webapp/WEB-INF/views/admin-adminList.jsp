      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Lista administratorów:</h1>
            <a href="/admin/add" class="d-none d-sm-inline-block btn  btn-primary shadow-sm"><i class="fas fa-user-shield"></i>   Dodaj administratora:</a>
          </div>
          ...
          <div class="row">
            <table class="table table-hover">
              ...
              <tbody>
              <c:forEach items="${adminsList}" var="admin" varStatus="index">
              <tr>
