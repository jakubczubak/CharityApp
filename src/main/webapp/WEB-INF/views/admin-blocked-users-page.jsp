        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <table class="table table-hover">
              ...
              <tbody>
              <c:forEach items="${banUsers}" var="user" varStatus="index">
              <tr>
                ...
                <td>
                  ...
                  <a href="/admin/user/unblock/${user.id}">
                  <button type="button" class="btn btn-success"><i class="fas fa-undo-alt"></i></button>
                </a>
                </td>
              </tr>
              </c:forEach>
